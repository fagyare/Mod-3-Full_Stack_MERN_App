...
function About() {
    ...
    return (
        ...
        We envision a world in which all young people, regardless of their zip code, have equitable access to the opportunity to actualize their dreams and realize their potential.</h4>
            <br/>
        </div>
