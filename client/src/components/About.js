...
function About() {
    ...
    return (
        <div className="about">
            ...
            <h3> Youth INC is a venture philanthropy organization whose mission is to transform the lives of NYC youth by empowering the nonprofits that serve them.
...
We envision a world in which all young people, regardless of their zip code, have equitable access to the opportunity to actualize their dreams and realize their potential.</h3>
            <br/>
        </div>
